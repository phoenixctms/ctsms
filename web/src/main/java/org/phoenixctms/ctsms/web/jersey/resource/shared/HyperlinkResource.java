...
public final class HyperlinkResource {
	...
	public HyperlinkOutVO addHyperlink(HyperlinkInVO in) throws AuthenticationException, AuthorisationException, ServiceException {
		return WebUtil.getServiceLocator().getHyperlinkService().addHyperlink(auth, in);
	}
