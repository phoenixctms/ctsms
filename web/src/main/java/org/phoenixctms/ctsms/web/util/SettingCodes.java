...
public interface SettingCodes {
	...
	public final static String VALIDATION_REPORTS_URL = "validation_reports_url";
	...
	public final static String STAFF_DUTY_ROSTER_TURNS_SHOW_COLLISIONS_PRESET = "staff_duty_roster_turns_show_collisions_preset";
	public final static String TRIAL_DUTY_ROSTER_TURNS_SHOW_COLLISIONS_PRESET = "trial_duty_roster_turns_show_collisions_preset";
	public final static String TEAM_MEMBER_PICKER_SHOW_COLLISIONS_PRESET = "team_member_picker_show_collisions_preset";
	...
	public final static String TEAM_MEMBER_ECRF_ENTRY_PRESET = "team_member_ecrf_entry_preset";
	public final static String TEAM_MEMBER_ECRF_DESIGN_PRESET = "team_member_ecrf_design_preset";
	...
	public static final String TIMELINE_ENABLE_DEPARTMENT_FILTER = "timeline_enable_department_filter";
	public static final String TIMELINE_ENABLE_TRIAL_STATUS_TYPE_FILTER = "timeline_enable_trial_status_type_filter";
	public static final String TIMELINE_ENABLE_TIMELINE_EVENTS_FILTER = "timeline_enable_timeline_events_filter";
	public static final String TIMELINE_ENABLE_TIMELINE_EVENT_TYPE_FILTER = "timeline_enable_timeline_event_type_filter";
	public static final String TIMELINE_ENABLE_SHOW_ALL_FILTER = "timeline_enable_show_all_filter";
	public static final String TIMELINE_ENABLE_VISIT_SCHEDULE_ITEMS_FILTER = "timeline_enable_visit_schedule_items_filter";
	public static final String TIMELINE_ENABLE_VISIT_TYPE_FILTER = "timeline_enable_visit_type_filter";
	public static final String TIMELINE_ENABLE_DESCRIPTION_FILTER = "timeline_enable_description_filter";
	public static final String TIMELINE_ENABLE_START_STOP_FILTER = "timeline_enable_start_stop_filter";
	...
	public static final String INVENTORY_BOOKING_SCHEDULE_SHOW_COLLISIONS_PRESET = "inventory_booking_schedule_show_collisions_preset";
	public static final String INVENTORY_BOOKING_SCHEDULE_ENABLE_DEPARTMENT_FILTER = "inventory_booking_schedule_enable_department_filter";
	public static final String INVENTORY_BOOKING_SCHEDULE_ENABLE_INVENTORY_CATEGORY_FILTER = "inventory_booking_schedule_enable_inventory_category_filter";
	public static final String INVENTORY_BOOKING_SCHEDULE_ENABLE_INVENTORY_FILTER = "inventory_booking_schedule_enable_inventory_filter";
	public static final String INVENTORY_BOOKING_SCHEDULE_ENABLE_PROBAND_FILTER = "inventory_booking_schedule_enable_proband_filter";
	public static final String INVENTORY_BOOKING_SCHEDULE_ENABLE_COURSE_FILTER = "inventory_booking_schedule_enable_course_filter";
	public static final String INVENTORY_BOOKING_SCHEDULE_ENABLE_TRIAL_FILTER = "inventory_booking_schedule_enable_trial_filter";
	public static final String INVENTORY_BOOKING_SCHEDULE_ENABLE_RESPONSIBLE_PERSON_FILTER = "inventory_booking_schedule_enable_responsible_person_filter";
	public static final String INVENTORY_BOOKING_SCHEDULE_ENABLE_BOOKINGS_FILTER = "inventory_booking_schedule_enable_bookings_filter";
	public static final String INVENTORY_BOOKING_SCHEDULE_ENABLE_VISIT_SCHEDULE_FILTER = "inventory_booking_schedule_enable_visit_schedule_filter";
	public static final String INVENTORY_BOOKING_SCHEDULE_ENABLE_PROBAND_STATUS_FILTER = "inventory_booking_schedule_enable_proband_status_filter";
	public static final String INVENTORY_BOOKING_SCHEDULE_ENABLE_COURSES_FILTER = "inventory_booking_schedule_enable_courses_filter";
	public static final String INVENTORY_BOOKING_SCHEDULE_ENABLE_INVENTORY_STATUS_FILTER = "inventory_booking_schedule_enable_inventory_status_filter";
	public static final String INVENTORY_BOOKING_SCHEDULE_ENABLE_COLLISIONS_FILTER = "inventory_booking_schedule_enable_collisions_filter";
	public static final String INVENTORY_BOOKING_SCHEDULE_ENABLE_MAINTENANCE_ITEMS_FILTER = "inventory_booking_schedule_enable_maintenance_items_filter";
	public static final String INVENTORY_BOOKING_SCHEDULE_ENABLE_HOLIDAYS_FILTER = "inventory_booking_schedule_enable_holidays_filter";
	...
	public static final String ADMIN_COURSE_PARTICIPATION_STATUS_SHOW_COLLISIONS_PRESET = "admin_course_participation_status_show_collisions_preset";
	public static final String COURSE_PARTICIPATION_STATUS_SHOW_COLLISIONS_PRESET = "course_participation_status_show_collisions_preset";
	...
	public final static String COURSE_INVENTORY_BOOKINGS_SHOW_COLLISIONS_PRESET = "course_inventory_bookings_show_collisions_preset";
	public final static String INVENTORY_BOOKINGS_SHOW_COLLISIONS_PRESET = "inventory_bookings_show_collisions_preset";
	public final static String PROBAND_INVENTORY_BOOKINGS_SHOW_COLLISIONS_PRESET = "proband_inventory_bookings_show_collisions_preset";
	public final static String TRIAL_INVENTORY_BOOKINGS_SHOW_COLLISIONS_PRESET = "trial_inventory_bookings_show_collisions_preset";
	public static final String DUTY_ROSTER_SCHEDULE_ENABLE_DEPARTMENT_FILTER = "duty_roster_schedule_enable_department_filter";
	public static final String DUTY_ROSTER_SCHEDULE_ENABLE_TRIAL_STATUS_TYPE_FILTER = "duty_roster_schedule_enable_trial_status_type_filter";
	public static final String DUTY_ROSTER_SCHEDULE_ENABLE_TRIAL_FILTER = "duty_roster_schedule_enable_trial_filter";
	public static final String DUTY_ROSTER_SCHEDULE_ENABLE_STAFF_CATEGORY_FILTER = "duty_roster_schedule_enable_staff_category_filter";
	public static final String DUTY_ROSTER_SCHEDULE_ENABLE_TEAM_MEMBER_FILTER = "duty_roster_schedule_enable_team_member_filter";
	public static final String DUTY_ROSTER_SCHEDULE_ENABLE_VISIT_SCHEDULE_FILTER = "duty_roster_schedule_enable_visit_schedule_filter";
	public static final String DUTY_ROSTER_SCHEDULE_ENABLE_VISIT_TYPE_FILTER = "duty_roster_schedule_enable_visit_type_filter";
	public static final String DUTY_ROSTER_SCHEDULE_ENABLE_DUTY_ROSTER_FILTER = "duty_roster_schedule_enable_duty_roster_filter";
	public static final String DUTY_ROSTER_SCHEDULE_ENABLE_TRIAL_BOOKINGS_FILTER = "duty_roster_schedule_enable_trial_bookings_filter";
	public static final String DUTY_ROSTER_SCHEDULE_ENABLE_STAFF_STATUS_FILTER = "duty_roster_schedule_enable_staff_status_filter";
	public static final String DUTY_ROSTER_SCHEDULE_ENABLE_COLLISIONS_FILTER = "duty_roster_schedule_enable_collisions_filter";
	public static final String DUTY_ROSTER_SCHEDULE_ENABLE_PROBAND_STATUS_FILTER = "duty_roster_schedule_enable_proband_status_filter";
	public static final String DUTY_ROSTER_SCHEDULE_ENABLE_COURSES_FILTER = "duty_roster_schedule_enable_courses_filter";
	public static final String DUTY_ROSTER_SCHEDULE_ENABLE_COURSE_BOOKINGS_FILTER = "duty_roster_schedule_enable_course_bookings_filter";
	public static final String DUTY_ROSTER_SCHEDULE_ENABLE_TIMELINE_EVENTS_FILTER = "duty_roster_schedule_enable_timeline_events_filter";
	public static final String DUTY_ROSTER_SCHEDULE_ENABLE_HOLIDAY_FILTER = "duty_roster_schedule_enable_holiday_filter";
	...
	public final static String INVENTORY_STATUS_OVERVIEW_SHOW_COLLISIONS_PRESET = "inventory_status_overview_show_collisions_preset";
	public final static String INVENTORY_STATUS_SHOW_COLLISIONS_PRESET = "inventory_status_show_collisions_preset";
	...
	public static final String STAFF_STATUS_SHOW_COLLISIONS_PRESET = "staff_status_show_collisions_preset";
	public static final String STAFF_STATUS_OVERVIEW_SHOW_COLLISIONS_PRESET = "staff_status_overview_show_collisions_preset";
	...
	public static final String PROBAND_STATUS_OVERVIEW_SHOW_COLLISIONS_PRESET = "proband_status_overview_show_collisions_preset";
	public static final String PROBAND_STATUS_SHOW_COLLISIONS_PRESET = "proband_status_show_collisions_preset";
	public static final String DUTY_ROSTER_SCHEDULE_SHOW_COLLISIONS_PRESET = "duty_roster_schedule_show_collisions_preset";
	...
	public final static String STRATIFICATION_CHART_SELECTION_VALUE_COLORS = "stratification_chart_selection_value_colors";
	...
	public static final String VISIT_SCHEDULE_ITEM_INTERNAL_PRESET = "visit_schedule_item_internal_preset";
	...
	public static final String PROBAND_VISIT_SCHEDULE_SHOW_COLLISIONS_PRESET = "proband_visit_schedule_show_collisions_preset";
	public static final String TRIAL_VISIT_SCHEDULE_SHOW_COLLISIONS_PRESET = "trial_visit_schedule_show_collisions_preset";
	...
	public static final String MASS_MAIL_STORE_MESSAGES_PRESET = "mass_mail_store_messages_preset";
