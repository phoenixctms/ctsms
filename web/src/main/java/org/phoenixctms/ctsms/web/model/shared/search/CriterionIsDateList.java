...
public class CriterionIsDateList extends CriterionListBase<Boolean> {

	public CriterionIsDateList(ArrayList<CriterionInVO> criterionsIn, HashMap<Long, CriterionPropertyVO> propertyVOsMap,
