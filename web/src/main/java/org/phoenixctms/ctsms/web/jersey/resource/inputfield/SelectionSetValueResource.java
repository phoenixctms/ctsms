...
public class SelectionSetValueResource {
	...
	@Produces({ MediaType.APPLICATION_JSON })
	@Path("{id}")
	public InputFieldSelectionSetValueOutVO deleteSelectionSetValue(@PathParam("id") Long id) throws AuthenticationException, AuthorisationException, ServiceException {
