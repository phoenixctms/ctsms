...
public class CriterionIsFloatList extends CriterionListBase<Boolean> {

	public CriterionIsFloatList(ArrayList<CriterionInVO> criterionsIn, HashMap<Long, CriterionPropertyVO> propertyVOsMap,
	...
	public Boolean get(int index) {
		...
		if (propertyVO != null && (CriterionValueType.FLOAT.equals(propertyVO.getValueType()) || CriterionValueType.FLOAT_HASH.equals(propertyVO.getValueType()))) {
