...
public class CriterionIsIntegerList extends CriterionListBase<Boolean> {

	public CriterionIsIntegerList(ArrayList<CriterionInVO> criterionsIn, HashMap<Long, CriterionPropertyVO> propertyVOsMap,
	...
	public Boolean get(int index) {
		...
		if (propertyVO != null && (CriterionValueType.LONG.equals(propertyVO.getValueType()) || CriterionValueType.LONG_HASH.equals(propertyVO.getValueType()))) {
