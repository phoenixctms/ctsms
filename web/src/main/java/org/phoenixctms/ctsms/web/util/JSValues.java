...
public enum JSValues {
	...
	INVENTORY_ID(GetParamNames.INVENTORY_ID.toString()),
	STAFF_ID(GetParamNames.STAFF_ID.toString()),
	COURSE_ID(GetParamNames.COURSE_ID.toString()),
	USER_ID(GetParamNames.USER_ID.toString()),
	...
	PICK_TARGET_FIELD(GetParamNames.PICK_TARGET_FIELD.toString()),
	PICK_TARGET_LABEL(GetParamNames.PICK_TARGET_LABEL.toString()),
	START(GetParamNames.START.toString()),
	STOP(GetParamNames.STOP.toString()),
	PICK_AJAX(GetParamNames.PICK_AJAX.toString()),
	PICK_AJAX_UPDATE(GetParamNames.PICK_AJAX_UPDATE.toString()),
	PICK_ADD_REMOTE_COMMAND(GetParamNames.PICK_ADD_REMOTE_COMMAND.toString()),
	...
	INPUT_FIELD_DELTA_SUMMARY_MAX(""), // ("inputFieldDeltaSummaryMax"),
	...
	ADMIN_UPCOMING_COURSE_OVERVIEW_URL(Urls.ADMIN_UPCOMING_COURSE_OVERVIEW.value()),
	EXPIRING_COURSE_OVERVIEW_URL(Urls.EXPIRING_COURSE_OVERVIEW.value()),
	ADMIN_EXPIRING_PARTICIPATION_OVERVIEW_URL(Urls.ADMIN_EXPIRING_PARTICIPATION_OVERVIEW.value()),
	INVENTORY_STATUS_OVERVIEW_URL(Urls.INVENTORY_STATUS_OVERVIEW.value()),
	INVENTORY_MAINTENANCE_OVERVIEW_URL(Urls.INVENTORY_MAINTENANCE_OVERVIEW.value()),
	INVENTORY_BOOKING_SCHEDULE_URL(Urls.INVENTORY_BOOKING_SCHEDULE.value()),
	INVENTORY_BOOKING_SUMMARY_OVERVIEW_URL(Urls.INVENTORY_BOOKING_SUMMARY_OVERVIEW.value()),
	PROBAND_STATUS_OVERVIEW_URL(Urls.PROBAND_STATUS_OVERVIEW.value()),
	AUTO_DELETION_PROBAND_OVERVIEW_URL(Urls.AUTO_DELETION_PROBAND_OVERVIEW.value()),
	STAFF_STATUS_OVERVIEW_URL(Urls.STAFF_STATUS_OVERVIEW.value()),
	STAFF_SHIFT_SUMMARY_OVERVIEW_URL(Urls.STAFF_SHIFT_SUMMARY_OVERVIEW.value()),
	UPCOMING_COURSE_OVERVIEW_URL(Urls.UPCOMING_COURSE_OVERVIEW.value()),
	EXPIRING_PARTICIPATION_OVERVIEW_URL(Urls.EXPIRING_PARTICIPATION_OVERVIEW.value()),
	...
	ECRF_PROGRESS_OVERVIEW_URL(Urls.ECRF_PROGRESS_OVERVIEW.value()),
	...
	STAFF_START_URL(Urls.STAFF_START.value()),
	COURSE_START_URL(Urls.COURSE_START.value()),
	USER_START_URL(Urls.USER_START.value()),
	...
	CURRENCY_SYMBOL(""),
	PF_LOCALE_STRING(""),
	FIELD_CALCULATION_DECODE_BASE64(Boolean.toString(true)); // ("forceDefaultGeolocation");
