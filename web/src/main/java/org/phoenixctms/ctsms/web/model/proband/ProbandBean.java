...
public class ProbandBean extends ManagedBeanBase implements SexSelectorListener {
	...
	private void initSets() {
		...
		count = (out == null ? null : WebUtil.getVisitScheduleItemCount(null, in.getId(), true));
	...
	public boolean isAutoDelete() {
		if (out != null && category != null) {
			return out.getPrivacyConsentStatus().isAutoDelete() && category.isPrivacyConsentControl();
		}
		return false;
	}
