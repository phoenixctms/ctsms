...
public class CriterionIsFilterItemsList extends CriterionListBase<Boolean> {

	public CriterionIsFilterItemsList(ArrayList<CriterionInVO> criterionsIn, HashMap<Long, CriterionPropertyVO> propertyVOsMap,
