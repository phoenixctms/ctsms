...
public class CourseParticipationStatusBean extends CourseParticipationStatusBeanBase {
	...
	public CourseParticipationStatusBean() {
		super();
		showCollisions = Settings.getBoolean(SettingCodes.COURSE_PARTICIPATION_STATUS_SHOW_COLLISIONS_PRESET, Bundle.SETTINGS,
				DefaultSettings.COURSE_PARTICIPATION_STATUS_SHOW_COLLISIONS_PRESET);
		today = new Date();
	}
