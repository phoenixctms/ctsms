...
public class CriterionIsTextList extends CriterionListBase<Boolean> {

	public CriterionIsTextList(ArrayList<CriterionInVO> criterionsIn, HashMap<Long, CriterionPropertyVO> propertyVOsMap,
