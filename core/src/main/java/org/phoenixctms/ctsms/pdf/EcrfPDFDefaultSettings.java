...
public final class EcrfPDFDefaultSettings {
	...
	public static final float SECTION_PAGE_BREAK_LOWER_MARGIN = 180.0f;
	// public static final boolean SHOW_VALIDATION_ERROR_MESSAGES = true;
	...
	public static final float LOG_FRAME_LINE_WIDTH = 0.3f;
	// public static final float SECTION_FRAME_LINE_WIDTH = 0.75f;
	public static final float INDEX_FRAME_LINE_WIDTH = 0.75f;
	public static final float HEAD_FRAME_LINE_WIDTH = 0.75f; // 0.0f;
	// public static final float SIGNATURE_FRAME_LINE_WIDTH = 0.75f;
	...
	private EcrfPDFDefaultSettings() {
	}
}
