...
public interface EcrfSpecificationPDFSettingCodes {
	...
	//public final static String PAGE_TITLE_LEFT_MARGIN = "page_title_left_margin";
	public final static String Y_PAGE_TITLE_INDENT = "y_page_title_indent";
	...
	public final static String X_SPECIFICATION_TABLE_FRAME_INDENT = "x_specification_table_frame_indent";
	public final static String Y_SPECIFICATION_TABLE_FRAME_INDENT = "y_specification_table_frame_indent";
	public final static String Y_SPECIFICATION_TABLE_HEAD_FRAME_INDENT = "y_specification_table_head_frame_indent";
	public final static String X_SPECIFICATION_TABLE_HEAD_FRAME_INDENT = "x_specification_table_head_frame_indent";
	public final static String SPECIFICATION_TABLE_FRAME_LINE_WIDTH = "specification_table_frame_line_width";
	...
	public static final String SPECIFICATION_TABLE_TEXT_COLOR = "specification_table_text_color";
	public static final String SPECIFICATION_TABLE_FRAME_COLOR = "specification_table_frame_color";
	public static final String SPECIFICATION_TABLE_COLUMN_SECTION_WIDTH = "specification_table_column_section_width";
	public static final String SPECIFICATION_TABLE_COLUMN_FIELD_TITLE_WIDTH = "specification_table_column_field_title_width";
	public static final String SPECIFICATION_TABLE_COLUMN_FIELD_TYPE_WIDTH = "specification_table_column_field_type_width";
	//public static final String SPECIFICATION_TABLE_COLUMN_SELECTION_VALUES_WIDTH = "specification_table_column_selection_values_width";
