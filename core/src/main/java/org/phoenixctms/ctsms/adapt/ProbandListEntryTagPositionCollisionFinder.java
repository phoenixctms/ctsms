...
public class ProbandListEntryTagPositionCollisionFinder extends CollisionFinder<ProbandListEntryTagInVO, ProbandListEntryTag, Trial> {

	private TrialDao trialDao;
	private ProbandListEntryTagDao probandListEntryTagDao;

	public ProbandListEntryTagPositionCollisionFinder(TrialDao trialDao, ProbandListEntryTagDao probandListEntryTagDao) {
	...
	protected Collection<ProbandListEntryTag> getCollidingItems(
		...
		return probandListEntryTagDao.findByTrialPosition(in.getTrialId(), in.getPosition());
	}
