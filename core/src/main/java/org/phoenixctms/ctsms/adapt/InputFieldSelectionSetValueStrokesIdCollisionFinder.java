...
public class InputFieldSelectionSetValueStrokesIdCollisionFinder extends InputFieldSelectionSetValueCollisionFinder {

	public InputFieldSelectionSetValueStrokesIdCollisionFinder(InputFieldDao inputFieldDao, InputFieldSelectionSetValueDao inputFieldSelectionSetValueDao) {
	...
	protected Collection<InputFieldSelectionSetValue> getCollidingItems(
		...
		return inputFieldSelectionSetValueDao.findByStrokesId(in.getFieldId(), in.getStrokesId());
	}
}
