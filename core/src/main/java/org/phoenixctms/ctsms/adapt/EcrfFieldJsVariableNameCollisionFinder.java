...
public class EcrfFieldJsVariableNameCollisionFinder extends CollisionFinder<ECRFFieldInVO, ECRFField, ECRF> {

	private ECRFDao ecrfDao;
	private ECRFFieldDao ecrfFieldDao;

	public EcrfFieldJsVariableNameCollisionFinder(ECRFDao ecrfDao, ECRFFieldDao ecrfFieldDao) {
	...
	protected Collection<ECRFField> getCollidingItems(
		...
		return ecrfFieldDao.findByEcrfJsVariableName(in.getEcrfId(), in.getJsVariableName());
	}
