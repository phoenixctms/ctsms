...
public class EcrfNameCollisionFinder extends CollisionFinder<ECRFInVO, ECRF, Trial> {

	private TrialDao trialDao;
	private ECRFDao ecrfDao;

	public EcrfNameCollisionFinder(TrialDao trialDao, ECRFDao ecrfDao) {
	...
	protected Collection<ECRF> getCollidingItems(
		...
		return ecrfDao.findByTrialName(in.getTrialId(), in.getName());
	}
