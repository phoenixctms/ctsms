...
public class ProbandListEntryTagStratificationFieldCollisionFinder extends CollisionFinder<ProbandListEntryTagInVO, ProbandListEntryTag, Trial> {

	private TrialDao trialDao;
	private ProbandListEntryTagDao probandListEntryTagDao;

	public ProbandListEntryTagStratificationFieldCollisionFinder(TrialDao trialDao, ProbandListEntryTagDao probandListEntryTagDao) {
	...
	protected Collection<ProbandListEntryTag> getCollidingItems(
		...
		return probandListEntryTagDao.findByTrialFieldStratificationRandomize(in.getTrialId(), in.getFieldId(), true, null);
	}
