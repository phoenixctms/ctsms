...
public class EcrfNameRevisionCollisionFinder extends CollisionFinder<ECRFInVO, ECRF, Trial> {

	private TrialDao trialDao;
	private ECRFDao ecrfDao;

	public EcrfNameRevisionCollisionFinder(TrialDao trialDao, ECRFDao ecrfDao) {
	...
	protected Collection<ECRF> getCollidingItems(
		...
		return ecrfDao.findCollidingTrialNameRevision(in.getTrialId(), in.getName(), in.getRevision());
	}
