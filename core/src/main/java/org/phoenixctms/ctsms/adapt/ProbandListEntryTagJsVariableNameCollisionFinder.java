...
public class ProbandListEntryTagJsVariableNameCollisionFinder extends CollisionFinder<ProbandListEntryTagInVO, ProbandListEntryTag, Trial> {

	private TrialDao trialDao;
	private ProbandListEntryTagDao probandListEntryTagDao;

	public ProbandListEntryTagJsVariableNameCollisionFinder(TrialDao trialDao, ProbandListEntryTagDao probandListEntryTagDao) {
	...
	protected Collection<ProbandListEntryTag> getCollidingItems(
		...
		return probandListEntryTagDao.findByTrialJsVariableName(in.getTrialId(), in.getJsVariableName());
	}
