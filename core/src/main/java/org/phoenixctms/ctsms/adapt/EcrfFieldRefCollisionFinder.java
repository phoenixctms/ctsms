...
public class EcrfFieldRefCollisionFinder extends CollisionFinder<ECRFFieldInVO, ECRFField, ECRF> {

	private ECRFDao ecrfDao;
	private ECRFFieldDao ecrfFieldDao;

	public EcrfFieldRefCollisionFinder(ECRFDao ecrfDao, ECRFFieldDao ecrfFieldDao) {
	...
	protected Collection<ECRFField> getCollidingItems(
		...
		return ecrfFieldDao.findByEcrfRef(in.getEcrfId(), in.getRef());
	}
