...
public final class PermissionProfileGrouping {
	...
	static {
		...
		addProfile(PermissionProfileGroup.INVENTORY, PermissionProfile.INVENTORY_MASTER_IDENTITY_DEPARTMENT);
		...
		addProfile(PermissionProfileGroup.INVENTORY, PermissionProfile.INVENTORY_DETAIL_IDENTITY_DEPARTMENT);
		...
		addProfile(PermissionProfileGroup.INVENTORY, PermissionProfile.INVENTORY_VIEW_IDENTITY_DEPARTMENT);
		...
		addProfile(PermissionProfileGroup.STAFF, PermissionProfile.STAFF_MASTER_IDENTITY_DEPARTMENT);
		...
		addProfile(PermissionProfileGroup.STAFF, PermissionProfile.STAFF_DETAIL_IDENTITY_DEPARTMENT);
		...
		addProfile(PermissionProfileGroup.STAFF, PermissionProfile.STAFF_VIEW_IDENTITY_DEPARTMENT);
		...
		addProfile(PermissionProfileGroup.COURSE, PermissionProfile.COURSE_MASTER_IDENTITY_DEPARTMENT);
		...
		addProfile(PermissionProfileGroup.COURSE, PermissionProfile.COURSE_DETAIL_IDENTITY_DEPARTMENT);
		...
		addProfile(PermissionProfileGroup.COURSE, PermissionProfile.COURSE_VIEW_IDENTITY_DEPARTMENT);
		...
		addProfile(PermissionProfileGroup.TRIAL, PermissionProfile.TRIAL_MASTER_IDENTITY_DEPARTMENT);
		...
		addProfile(PermissionProfileGroup.TRIAL, PermissionProfile.TRIAL_DETAIL_IDENTITY_DEPARTMENT);
		...
		addProfile(PermissionProfileGroup.TRIAL, PermissionProfile.TRIAL_VIEW_IDENTITY_DEPARTMENT);
		...
		addProfile(PermissionProfileGroup.MASS_MAIL, PermissionProfile.MASS_MAIL_MASTER_IDENTITY_DEPARTMENT);
		...
		addProfile(PermissionProfileGroup.MASS_MAIL, PermissionProfile.MASS_MAIL_DETAIL_IDENTITY_DEPARTMENT);
		...
		addProfile(PermissionProfileGroup.MASS_MAIL, PermissionProfile.MASS_MAIL_VIEW_IDENTITY_DEPARTMENT);
		...
		addProfile(PermissionProfileGroup.USER, PermissionProfile.USER_IDENTITY_DEPARTMENT);
