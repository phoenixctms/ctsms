...
public interface SystemMessageCodes {
	...
	public final static String PROBAND_GROUP_DELETED_MASS_MAIL_UPDATED = "proband_group_deleted_mass_mail_updated";
	...
	public final static String VISIT_DELETED_MASS_MAIL_UPDATED = "visit_deleted_mass_mail_updated";
	...
	public final static String PRIVACY_CONSENT_STATUS_CONFIRMED = "privacy_consent_status_confirmed";
	public final static String PROBAND_EMAIL_UNSUBSCRIBED = "proband_email_unsubscribed";
	...
	public final static String LOGON_FAILED = "logon_failed";
	public final static String LOGON_SUCCESSFUL = "logon_successful";
