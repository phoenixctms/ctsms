...
public final class OmittedFields {
	...
	static {
		...
		addProtectedField(protectedOutVOFieldMap, JobFileVO.class, "datas");
		addProtectedField(protectedOutVOFieldMap, JobFileVO.class, "fileName");
		...
		addProtectedField(protectedInVOFieldMap, JobAddVO.class, "datas");
		addProtectedField(protectedInVOFieldMap, JobAddVO.class, "fileName");
		addProtectedField(protectedInVOFieldMap, JobUpdateVO.class, "datas");
		addProtectedField(protectedInVOFieldMap, JobUpdateVO.class, "fileName");
