...
public class QueryParameterValue {
	...
	public enum QueryParameterValueType {
		...
		TODAY,
		NOW,
		TODAY_PLUS_VARIABLE_PERIOD,
		TODAY_MINUS_VARIABLE_PERIOD,
		NOW_PLUS_VARIABLE_PERIOD,
		NOW_MINUS_VARIABLE_PERIOD,
		CONTEXT_USER_ID,
		CONTEXT_USER_DEPARTMENT_ID,
		CONTEXT_IDENTITY_ID,
		CONTEXT_IDENTITY_DEPARTMENT_ID
	}
