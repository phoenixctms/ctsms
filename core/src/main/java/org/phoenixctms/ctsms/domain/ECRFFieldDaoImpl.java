...
extends ECRFFieldDaoBase
{
		...
		if (ecrfFieldVO != null && ecrfFieldVO.getTrial() != null && ecrfFieldVO.getField() != null && ecrfFieldVO.getEcrf() != null) {
			...
			if (Settings.getBoolean(SettingCodes.UNIQUE_ECRF_NAMES, Bundle.SETTINGS, DefaultSettings.UNIQUE_ECRF_NAMES)) {
				if (section != null && section.length() > 0) {
					...
					return MessageFormat.format(UNIQUE_ECRF_NAME_ECRF_FIELD_NAME, ecrfFieldVO.getTrial().getName(), ecrfFieldVO.getEcrf().getName(),  Long.toString(ecrfFieldVO.getPosition()), ecrfFieldVO.getField().getName());
				}
			} else {
				...
				if (visit != null || group != null) {
					...
					if (section != null && section.length() > 0) {
						return MessageFormat.format(UNIQUE_GROUP_VISIT_SECTION_ECRF_FIELD_NAME, ecrfFieldVO.getTrial().getName(), groupVisit.toString(),Long.toString(ecrfFieldVO.getEcrf().getPosition()),ecrfFieldVO.getEcrf().getName(), section, Long.toString(ecrfFieldVO.getPosition()), ecrfFieldVO.getField().getName());
					} else {
						return MessageFormat.format(UNIQUE_GROUP_VISIT_ECRF_FIELD_NAME, ecrfFieldVO.getTrial().getName(), groupVisit.toString(),Long.toString(ecrfFieldVO.getEcrf().getPosition()),ecrfFieldVO.getEcrf().getName(),  Long.toString(ecrfFieldVO.getPosition()), ecrfFieldVO.getField().getName());
					}
				} else {
					if (section != null && section.length() > 0) {
						return MessageFormat.format(UNIQUE_ECRF_POSITION_SECTION_ECRF_FIELD_NAME, ecrfFieldVO.getTrial().getName(), Long.toString(ecrfFieldVO.getEcrf().getPosition()),ecrfFieldVO.getEcrf().getName(), section, Long.toString(ecrfFieldVO.getPosition()), ecrfFieldVO.getField().getName());
					} else {
						return MessageFormat.format(UNIQUE_ECRF_POSITION_ECRF_FIELD_NAME, ecrfFieldVO.getTrial().getName(), Long.toString(ecrfFieldVO.getEcrf().getPosition()),ecrfFieldVO.getEcrf().getName(),  Long.toString(ecrfFieldVO.getPosition()), ecrfFieldVO.getField().getName());
					}
				}
			}
		}
	...
	@Override
	protected Collection<ECRFField> handleFindByTrialEcrfSectionSeriesJs(Long trialId, Long ecrfId, String section, boolean sort, Boolean series, Boolean js, PSFVO psf) throws Exception {
		org.hibernate.Criteria ecrfFieldCriteria = createEcrfFieldCriteria();
