			...
			if (isDay != null && isDay) {
				...
				if (visitScheduleItem.getStart() != null && visitScheduleItem.getStop() != null) {
					if (DateCalc.isStartOfDay(visitScheduleItem.getStart())) {
						if (DateCalc.isEndOfDay(visitScheduleItem.getStop())) {
						...
						} else if (DateCalc.isStartOfDay(visitScheduleItem.getStop())) {
							return L10nUtil.getProbandListExcelLabel(Locales.USER, ProbandListExcelLabelCodes.VISIT_SCHEDULE_APPOINTMENT_START_STOP_VALUE, ExcelUtil.DEFAULT_LABEL,
									CommonUtil.formatDate(visitScheduleItem.getStart(), ExcelUtil.EXCEL_DATE_PATTERN, L10nUtil.getLocale(Locales.USER)),
	...
	protected SpreadSheetWriter createSpreadSheetWriter(boolean omitFields) {
		if (logLevel != null) {
			switch (logLevel) {
				case ENROLLMENT:
					return new SpreadSheetWriter(this,
							...
							Settings.getIntNullable(ProbandListExcelSettingCodes.ENROLLMENT_LOG_ROW_OFFSET_FIRST_PAGE, Bundle.PROBAND_LIST_EXCEL,
									ProbandListExcelDefaultSettings.ENROLLMENT_LOG_ROW_OFFSET_FIRST_PAGE),
							Settings.getIntNullable(ProbandListExcelSettingCodes.ENROLLMENT_LOG_ROW_OFFSET_OTHER_PAGES, Bundle.PROBAND_LIST_EXCEL,
									ProbandListExcelDefaultSettings.ENROLLMENT_LOG_ROW_OFFSET_OTHER_PAGES),
							Settings.getIntNullable(ProbandListExcelSettingCodes.ENROLLMENT_LOG_COL_OFFSET, Bundle.PROBAND_LIST_EXCEL,
									ProbandListExcelDefaultSettings.ENROLLMENT_LOG_COL_OFFSET),
				...
				case PRE_SCREENING:
					return new SpreadSheetWriter(this,
							...
							Settings.getIntNullable(ProbandListExcelSettingCodes.PRE_SCREENING_LOG_ROW_OFFSET_FIRST_PAGE, Bundle.PROBAND_LIST_EXCEL,
									ProbandListExcelDefaultSettings.PRE_SCREENING_LOG_ROW_OFFSET_FIRST_PAGE),
							Settings.getIntNullable(ProbandListExcelSettingCodes.PRE_SCREENING_LOG_ROW_OFFSET_OTHER_PAGES, Bundle.PROBAND_LIST_EXCEL,
									ProbandListExcelDefaultSettings.PRE_SCREENING_LOG_ROW_OFFSET_OTHER_PAGES),
							Settings.getIntNullable(ProbandListExcelSettingCodes.PRE_SCREENING_LOG_COL_OFFSET, Bundle.PROBAND_LIST_EXCEL,
									ProbandListExcelDefaultSettings.PRE_SCREENING_LOG_COL_OFFSET),
				...
				case SCREENING:
					return new SpreadSheetWriter(this,
							...
							Settings.getIntNullable(ProbandListExcelSettingCodes.SCREENING_LOG_ROW_OFFSET_FIRST_PAGE, Bundle.PROBAND_LIST_EXCEL,
									ProbandListExcelDefaultSettings.SCREENING_LOG_ROW_OFFSET_FIRST_PAGE),
							Settings.getIntNullable(ProbandListExcelSettingCodes.SCREENING_LOG_ROW_OFFSET_OTHER_PAGES, Bundle.PROBAND_LIST_EXCEL,
									ProbandListExcelDefaultSettings.SCREENING_LOG_ROW_OFFSET_OTHER_PAGES),
							Settings.getIntNullable(ProbandListExcelSettingCodes.SCREENING_LOG_COL_OFFSET, Bundle.PROBAND_LIST_EXCEL,
									ProbandListExcelDefaultSettings.SCREENING_LOG_COL_OFFSET),
				...
				case SICL:
					return new SpreadSheetWriter(
							...
							Settings.getIntNullable(ProbandListExcelSettingCodes.SICL_ROW_OFFSET_FIRST_PAGE, Bundle.PROBAND_LIST_EXCEL,
									ProbandListExcelDefaultSettings.SICL_ROW_OFFSET_FIRST_PAGE),
							Settings.getIntNullable(ProbandListExcelSettingCodes.SICL_ROW_OFFSET_OTHER_PAGES, Bundle.PROBAND_LIST_EXCEL,
									ProbandListExcelDefaultSettings.SICL_ROW_OFFSET_OTHER_PAGES),
							Settings.getIntNullable(ProbandListExcelSettingCodes.SICL_COL_OFFSET, Bundle.PROBAND_LIST_EXCEL,
				...
				case PROBAND_STATUS:
					return new SpreadSheetWriter(
							...
							Settings.getIntNullable(ProbandListExcelSettingCodes.PROBAND_STATUS_ROW_OFFSET_FIRST_PAGE, Bundle.PROBAND_LIST_EXCEL,
									ProbandListExcelDefaultSettings.PROBAND_STATUS_ROW_OFFSET_FIRST_PAGE),
							Settings.getIntNullable(ProbandListExcelSettingCodes.PROBAND_STATUS_ROW_OFFSET_OTHER_PAGES, Bundle.PROBAND_LIST_EXCEL,
									ProbandListExcelDefaultSettings.PROBAND_STATUS_ROW_OFFSET_OTHER_PAGES),
							Settings.getIntNullable(ProbandListExcelSettingCodes.PROBAND_STATUS_COL_OFFSET, Bundle.PROBAND_LIST_EXCEL,
									ProbandListExcelDefaultSettings.PROBAND_STATUS_COL_OFFSET),
			...
			return new SpreadSheetWriter(this,
					...
					Settings.getIntNullable(ProbandListExcelSettingCodes.PROBAND_LIST_ROW_OFFSET_FIRST_PAGE, Bundle.PROBAND_LIST_EXCEL,
							ProbandListExcelDefaultSettings.PROBAND_LIST_ROW_OFFSET_FIRST_PAGE),
					Settings.getIntNullable(ProbandListExcelSettingCodes.PROBAND_LIST_ROW_OFFSET_OTHER_PAGES, Bundle.PROBAND_LIST_EXCEL,
							ProbandListExcelDefaultSettings.PROBAND_LIST_ROW_OFFSET_OTHER_PAGES),
					Settings.getIntNullable(ProbandListExcelSettingCodes.PROBAND_LIST_COL_OFFSET, Bundle.PROBAND_LIST_EXCEL,
							ProbandListExcelDefaultSettings.PROBAND_LIST_COL_OFFSET),
