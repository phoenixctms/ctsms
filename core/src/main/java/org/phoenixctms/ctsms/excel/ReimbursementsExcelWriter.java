	...
	protected SpreadSheetWriter createSpreadSheetWriter(boolean omitFields) {
		if (method != null) {
			switch (method.getPaymentMethod()) {
				case PETTY_CASH:
					return new SpreadSheetWriter(this,
							...
							Settings.getIntNullable(ReimbursementsExcelSettingCodes.PETTY_CASH_ROW_OFFSET_FIRST_PAGE, Bundle.REIMBURSEMENTS_EXCEL,
									ReimbursementsExcelDefaultSettings.PETTY_CASH_ROW_OFFSET_FIRST_PAGE),
							Settings.getIntNullable(ReimbursementsExcelSettingCodes.PETTY_CASH_ROW_OFFSET_OTHER_PAGES, Bundle.REIMBURSEMENTS_EXCEL,
									ReimbursementsExcelDefaultSettings.PETTY_CASH_ROW_OFFSET_OTHER_PAGES),
							Settings.getIntNullable(ReimbursementsExcelSettingCodes.PETTY_CASH_COL_OFFSET, Bundle.REIMBURSEMENTS_EXCEL,
									ReimbursementsExcelDefaultSettings.PETTY_CASH_COL_OFFSET),
				...
				case VOUCHER:
					return new SpreadSheetWriter(
							...
							Settings.getIntNullable(ReimbursementsExcelSettingCodes.VOUCHER_ROW_OFFSET_FIRST_PAGE, Bundle.REIMBURSEMENTS_EXCEL,
									ReimbursementsExcelDefaultSettings.VOUCHER_ROW_OFFSET_FIRST_PAGE),
							Settings.getIntNullable(ReimbursementsExcelSettingCodes.VOUCHER_ROW_OFFSET_OTHER_PAGES, Bundle.REIMBURSEMENTS_EXCEL,
									ReimbursementsExcelDefaultSettings.VOUCHER_ROW_OFFSET_OTHER_PAGES),
							Settings.getIntNullable(ReimbursementsExcelSettingCodes.VOUCHER_COL_OFFSET, Bundle.REIMBURSEMENTS_EXCEL,
									ReimbursementsExcelDefaultSettings.VOUCHER_COL_OFFSET),
				...
				case WIRE_TRANSFER:
					return new SpreadSheetWriter(this,
							...
							Settings.getIntNullable(ReimbursementsExcelSettingCodes.WIRE_TRANSFER_ROW_OFFSET_FIRST_PAGE, Bundle.REIMBURSEMENTS_EXCEL,
									ReimbursementsExcelDefaultSettings.WIRE_TRANSFER_ROW_OFFSET_FIRST_PAGE),
							Settings.getIntNullable(ReimbursementsExcelSettingCodes.WIRE_TRANSFER_ROW_OFFSET_OTHER_PAGES, Bundle.REIMBURSEMENTS_EXCEL,
									ReimbursementsExcelDefaultSettings.WIRE_TRANSFER_ROW_OFFSET_OTHER_PAGES),
							Settings.getIntNullable(ReimbursementsExcelSettingCodes.WIRE_TRANSFER_COL_OFFSET, Bundle.REIMBURSEMENTS_EXCEL,
									ReimbursementsExcelDefaultSettings.WIRE_TRANSFER_COL_OFFSET),
			...
			return new SpreadSheetWriter(this,
					...
					Settings.getIntNullable(ReimbursementsExcelSettingCodes.ROW_OFFSET_FIRST_PAGE, Bundle.REIMBURSEMENTS_EXCEL,
							ReimbursementsExcelDefaultSettings.ROW_OFFSET_FIRST_PAGE),
					Settings.getIntNullable(ReimbursementsExcelSettingCodes.ROW_OFFSET_OTHER_PAGES, Bundle.REIMBURSEMENTS_EXCEL,
							ReimbursementsExcelDefaultSettings.ROW_OFFSET_OTHER_PAGES),
					Settings.getIntNullable(ReimbursementsExcelSettingCodes.COL_OFFSET, Bundle.REIMBURSEMENTS_EXCEL,
