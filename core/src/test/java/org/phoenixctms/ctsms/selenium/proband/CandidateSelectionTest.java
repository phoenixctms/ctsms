...
//mvn surefire:test -Dtest=CreateProbandTest -DskipTests=false -Dwebdriver.chrome.driver=C:\chromedriver_win32\chromedriver.exe -Dctsms.base.url=http://localhost:8080/ctsms-web -Dctsms.log.path="D:\seleniumtestoutput"
