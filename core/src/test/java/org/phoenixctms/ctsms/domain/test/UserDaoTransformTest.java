...
public class UserDaoTransformTest extends DaoTransformTestBase {
  ...
  /**
   * Test for method UserDao.toUserSettingsInVO
   *
   * @see org.phoenixctms.ctsms.domain.UserDao#toUserSettingsInVO(org.phoenixctms.ctsms.domain.User source, org.phoenixctms.ctsms.vo.UserSettingsInVO target)
   */
  @Test
  public void testToUserSettingsInVO() {
    Assert.fail("Test 'UserDaoTransformTest.testToUserSettingsInVO' not implemented!");
  }

    /**
   * Test for method userSettingsInVOToEntity
   *
   * @see org.phoenixctms.ctsms.domain.UserDao#userSettingsInVOToEntity(org.phoenixctms.ctsms.vo.UserSettingsInVO source, org.phoenixctms.ctsms.domain.User target, boolean copyIfNull)
   */
  @Test
  public void testUserSettingsInVOToEntity() {
