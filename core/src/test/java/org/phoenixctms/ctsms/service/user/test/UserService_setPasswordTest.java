...
public class UserService_setPasswordTest extends UserServiceBaseTest {
  ...
  /*
   * Add test methods for each test case of the 'UserService.org.andromda.cartridges.spring.metafacades.SpringServiceOperationLogicImpl[org.phoenixctms.ctsms.service.user.UserService.setPassword]()' service method.
   */
