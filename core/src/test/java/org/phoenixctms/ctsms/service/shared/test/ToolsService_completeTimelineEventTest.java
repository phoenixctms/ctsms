...
public class ToolsService_completeTimelineEventTest extends ToolsServiceBaseTest {
  ...
  /**
   * Test succes path for service method <code>completeTimelineEvent</code>
   *
   * Tests expected behaviour of service method.
   */
  @Test
  public void testSuccessPath() {
    Assert.fail( "Test 'ToolsService_completeTimelineEventTest.testSuccessPath()}' not implemented." );
  }

  /*
   * Add test methods for each test case of the 'ToolsService.org.andromda.cartridges.spring.metafacades.SpringServiceOperationLogicImpl[org.phoenixctms.ctsms.service.shared.ToolsService.completeTimelineEvent]()' service method.
   */
