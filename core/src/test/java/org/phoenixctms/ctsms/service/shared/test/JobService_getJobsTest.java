...
public class JobService_getJobsTest extends JobServiceBaseTest {
  ...
  /**
   * Test succes path for service method <code>getJobs</code>
   *
   * Tests expected behaviour of service method.
   */
  @Test
  public void testSuccessPath() {
    Assert.fail( "Test 'JobService_getJobsTest.testSuccessPath()}' not implemented." );
  }

  /*
   * Add test methods for each test case of the 'JobService.org.andromda.cartridges.spring.metafacades.SpringServiceOperationLogicImpl[org.phoenixctms.ctsms.service.shared.JobService.getJobs]()' service method.
   */
