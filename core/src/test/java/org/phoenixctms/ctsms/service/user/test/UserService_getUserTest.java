...
public class UserService_getUserTest extends UserServiceBaseTest {
  ...
  /*
   * Add test methods for each test case of the 'UserService.org.andromda.cartridges.spring.metafacades.SpringServiceOperationLogicImpl[org.phoenixctms.ctsms.service.user.getUser]()' service method.
   */
