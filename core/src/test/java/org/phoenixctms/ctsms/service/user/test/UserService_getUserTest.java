...
public class UserService_getUserTest extends UserServiceBaseTest {
  ...
  /**
   * Test succes path for service method <code>getUser</code>
   *
   * Tests expected behaviour of service method.
   */
  @Test
  public void testSuccessPath() {
    Assert.fail( "Test 'UserService_getUserTest.testSuccessPath()}' not implemented." );
  }

  /*
   * Add test methods for each test case of the 'UserService.org.andromda.cartridges.spring.metafacades.SpringServiceOperationLogicImpl[org.phoenixctms.ctsms.service.user.UserService.getUser]()' service method.
   */
