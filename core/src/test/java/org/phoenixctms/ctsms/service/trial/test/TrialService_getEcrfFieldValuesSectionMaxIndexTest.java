...
public class TrialService_getEcrfFieldValuesSectionMaxIndexTest extends TrialServiceBaseTest {
  ...
  /**
   * Test succes path for service method <code>getEcrfFieldValuesSectionMaxIndex</code>
   *
   * Tests expected behaviour of service method.
   */
  @Test
  public void testSuccessPath() {
    Assert.fail( "Test 'TrialService_getEcrfFieldValuesSectionMaxIndexTest.testSuccessPath()}' not implemented." );
  }
