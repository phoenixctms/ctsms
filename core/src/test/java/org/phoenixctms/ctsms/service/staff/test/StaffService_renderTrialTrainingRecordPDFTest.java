...
public class StaffService_renderTrialTrainingRecordPDFTest extends StaffServiceBaseTest {
  ...
  /**
   * Test succes path for service method <code>renderTrialTrainingRecordPDF</code>
   *
   * Tests expected behaviour of service method.
   */
  @Test
  public void testSuccessPath() {
    Assert.fail( "Test 'StaffService_renderTrialTrainingRecordPDFTest.testSuccessPath()}' not implemented." );
  }

  /*
   * Add test methods for each test case of the 'StaffService.org.andromda.cartridges.spring.metafacades.SpringServiceOperationLogicImpl[org.phoenixctms.ctsms.service.staff.StaffService.renderTrialTrainingRecordPDF]()' service method.
   */
