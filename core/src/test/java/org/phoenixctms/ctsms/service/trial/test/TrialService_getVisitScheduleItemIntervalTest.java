...
public class TrialService_getVisitScheduleItemIntervalTest extends TrialServiceBaseTest {
  ...
  /**
   * Test succes path for service method <code>getVisitScheduleItemInterval</code>
   *
   * Tests expected behaviour of service method.
   */
  @Test
  public void testSuccessPath() {
    Assert.fail( "Test 'TrialService_getVisitScheduleItemIntervalTest.testSuccessPath()}' not implemented." );
  }

  /*
   * Add test methods for each test case of the 'TrialService.org.andromda.cartridges.spring.metafacades.SpringServiceOperationLogicImpl[org.phoenixctms.ctsms.service.trial.TrialService.getVisitScheduleItemInterval]()' service method.
   */
