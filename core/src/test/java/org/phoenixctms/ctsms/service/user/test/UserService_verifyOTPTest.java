...
public class UserService_verifyOTPTest extends UserServiceBaseTest {
  ...
  /**
   * Test succes path for service method <code>verifyOTP</code>
   *
   * Tests expected behaviour of service method.
   */
  @Test
  public void testSuccessPath() {
    Assert.fail( "Test 'UserService_verifyOTPTest.testSuccessPath()}' not implemented." );
  }

  /*
   * Add test methods for each test case of the 'UserService.org.andromda.cartridges.spring.metafacades.SpringServiceOperationLogicImpl[org.phoenixctms.ctsms.service.user.UserService.verifyOTP]()' service method.
   */
