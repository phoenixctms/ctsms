...
public class TrialService_getVisitScheduleItemListTest extends TrialServiceBaseTest {
  ...
  /*
   * Add test methods for each test case of the 'TrialService.org.andromda.cartridges.spring.metafacades.SpringServiceOperationLogicImpl[org.phoenixctms.ctsms.service.trial.getVisitScheduleItemList]()' service method.
   */
