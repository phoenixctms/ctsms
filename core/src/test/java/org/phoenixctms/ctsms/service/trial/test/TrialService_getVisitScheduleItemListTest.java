...
public class TrialService_getVisitScheduleItemListTest extends TrialServiceBaseTest {
	...
	/**
	 * Test succes path for service method <code>getVisitScheduleItemList</code>
	 *
	 * Tests expected behaviour of service method.
	 */
	@Test
	public void testSuccessPath() {
		Assert.fail("Test 'TrialService_getVisitScheduleItemListTest.testSuccessPath()}' not implemented.");
	}
	/*
	 * Add test methods for each test case of the 'TrialService.org.andromda.cartridges.spring.metafacades.SpringServiceOperationLogicImpl[org.phoenixctms.ctsms.service.trial.TrialService.getVisitScheduleItemList]()' service method.
	 */
	/**
