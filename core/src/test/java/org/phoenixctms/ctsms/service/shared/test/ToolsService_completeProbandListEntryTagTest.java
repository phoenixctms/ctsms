...
public class ToolsService_completeProbandListEntryTagTest extends ToolsServiceBaseTest {
  ...
  /*
   * Add test methods for each test case of the 'ToolsService.org.andromda.cartridges.spring.metafacades.SpringServiceOperationLogicImpl[org.phoenixctms.ctsms.service.shared.completeProbandListEntryTag]()' service method.
   */
