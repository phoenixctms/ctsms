...
public class ToolsService_completeProbandListEntryTagTest extends ToolsServiceBaseTest {
  ...
  /**
   * Test succes path for service method <code>completeProbandListEntryTag</code>
   *
   * Tests expected behaviour of service method.
   */
  @Test
  public void testSuccessPath() {
    Assert.fail( "Test 'ToolsService_completeProbandListEntryTagTest.testSuccessPath()}' not implemented." );
  }

  /*
   * Add test methods for each test case of the 'ToolsService.org.andromda.cartridges.spring.metafacades.SpringServiceOperationLogicImpl[org.phoenixctms.ctsms.service.shared.ToolsService.completeProbandListEntryTag]()' service method.
   */
