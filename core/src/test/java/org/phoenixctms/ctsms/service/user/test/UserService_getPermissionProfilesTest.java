...
public class UserService_getPermissionProfilesTest extends UserServiceBaseTest {
  ...
  public void testSuccessPath() {
    Assert.fail( "Test 'UserService_getPermissionProfilesTest.testSuccessPath()}' not implemented." );
  }

  /*
   * Add test methods for each test case of the 'UserService.org.andromda.cartridges.spring.metafacades.SpringServiceOperationLogicImpl[org.phoenixctms.ctsms.service.user.UserService.getPermissionProfiles]()' service method.
   */
