...
public class TrialService_getLastEcrfFieldStatusEntryTest extends TrialServiceBaseTest {
  ...
  /**
   * Test succes path for service method <code>getLastEcrfFieldStatusEntry</code>
   *
   * Tests expected behaviour of service method.
   */
  @Test
  public void testSuccessPath() {
    Assert.fail( "Test 'TrialService_getLastEcrfFieldStatusEntryTest.testSuccessPath()}' not implemented." );
  }

  /*
   * Add test methods for each test case of the 'TrialService.org.andromda.cartridges.spring.metafacades.SpringServiceOperationLogicImpl[org.phoenixctms.ctsms.service.trial.TrialService.getLastEcrfFieldStatusEntry]()' service method.
   */
