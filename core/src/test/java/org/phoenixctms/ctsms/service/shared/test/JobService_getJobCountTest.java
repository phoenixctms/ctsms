...
public class JobService_getJobCountTest extends JobServiceBaseTest {
  ...
  /**
   * Test succes path for service method <code>getJobCount</code>
   *
   * Tests expected behaviour of service method.
   */
  @Test
  public void testSuccessPath() {
    Assert.fail( "Test 'JobService_getJobCountTest.testSuccessPath()}' not implemented." );
  }

  /*
   * Add test methods for each test case of the 'JobService.org.andromda.cartridges.spring.metafacades.SpringServiceOperationLogicImpl[org.phoenixctms.ctsms.service.shared.JobService.getJobCount]()' service method.
   */
