...
public class InputFieldService_deleteSelectionSetValueTest extends InputFieldServiceBaseTest {
	...
	/**
	 * Test succes path for service method <code>deleteSelectionSetValue</code>
	 *
	 * Tests expected behaviour of service method.
	 */
	@Test
	public void testSuccessPath() {
		Assert.fail("Test 'InputFieldService_deleteSelectionSetValueTest.testSuccessPath()}' not implemented.");
	}
	/*
