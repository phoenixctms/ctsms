...
public class EcrfRowWriter extends RowWriter {
	...
	private final static int NAME_COLUMN_INDEX = 5;
	private final static int TITLE_COLUMN_INDEX = 6;
	private final static int DESCRIPTION_COLUMN_INDEX = 7;
	private final static int ENROLLMENT_STATUS_COLUMN_INDEX = 8;
