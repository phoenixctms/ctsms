...
public class DemoDataProvider {
	...
	private UserOutVO assignUser(StaffOutVO staff) throws Exception {
		...
		if (user != null) {
			...
			modifiedUser.setVisibleInventoryTabList(null);
			modifiedUser.setEnableStaffModule(true);
			modifiedUser.setVisibleStaffTabList(null);
			modifiedUser.setEnableCourseModule(true);
			modifiedUser.setVisibleCourseTabList(null);
			modifiedUser.setEnableTrialModule(true);
			modifiedUser.setVisibleTrialTabList(null);
			modifiedUser.setEnableInputFieldModule(true);
			modifiedUser.setVisibleInputFieldTabList(null);
			modifiedUser.setEnableProbandModule(true);
			modifiedUser.setVisibleProbandTabList(null);
			modifiedUser.setEnableMassMailModule(true);
			modifiedUser.setVisibleMassMailTabList(null);
	...
	private AuthenticationVO getAuth(int departmentNum, int userNum) {
		return new AuthenticationVO(getUsername(departmentNum, userNum), getUserPassword(departmentNum, userNum), null, null, "localhost", CommonUtil.DBTOOL_REALM);
	}
