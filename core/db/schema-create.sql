    ...
    create table INPUT_FIELD (
        ...
        CATEGORY CHARACTER VARYING(1024),
        TOP_COMMENT_L10N_KEY TEXT,
        BOTTOM_COMMENT_L10N_KEY TEXT,
    ...
    create table MASS_MAIL (
        ...
        SUBJECT_FORMAT CHARACTER VARYING(1024),
        ...
        ATTACH_VISIT_PLANS BOOLEAN not null,
        MODIFIED_TIMESTAMP TIMESTAMP WITHOUT TIME ZONE not null,
        VERSION BIGINT not null,
        DEFERRED_DELETE BOOLEAN not null,
        DEFERRED_DELETE_REASON TEXT,
        ATTACH_INQUIRIES_OPTIONAL BOOLEAN not null,
        ATTACH_PROBAND_LIST_ENTRY_TAGS_OPTIONAL BOOLEAN not null,
        ATTACH_ECRFS_OPTIONAL BOOLEAN not null,
        ATTACH_PROBAND_LETTER_OPTIONAL BOOLEAN not null,
        ATTACH_REIMBURSEMENTS_PDF_OPTIONAL BOOLEAN not null,
        ATTACH_VISIT_PLANS_OPTIONAL BOOLEAN not null,
        ATTACH_PROBAND_FILES_OPTIONAL BOOLEAN not null,
        ATTACH_TRIAL_FILES_OPTIONAL BOOLEAN not null,
    ...
    create table ORGANISATION_CONTACT_PARTICULARS (
        ...
        ORGANISATION_NAME_NORMALIZED CHARACTER VARYING(1024) not null,
        primary key (ID)
    );
    ...
    create table PERSON_CONTACT_PARTICULARS (
        ...
        FIRST_NAME_NORMALIZED CHARACTER VARYING(1024) not null,
        LAST_NAME CHARACTER VARYING(1024) not null,
        LAST_NAME_NORMALIZED CHARACTER VARYING(1024) not null,
    ...
    create table PROBAND_CONTACT_PARTICULARS (
        ...
        COMMENT_HASH BYTEA,
        ALIAS CHARACTER VARYING(1024),
        ALIAS_NORMALIZED CHARACTER VARYING(1024),
        CONTENT_TYPE_FK BIGINT,
        primary key (ID)
    );
    ...
    create table TEAM_MEMBER (
        ...
        ECRF_ENTRY BOOLEAN not null,
        MODIFIED_TIMESTAMP TIMESTAMP WITHOUT TIME ZONE not null,
        VERSION BIGINT not null,
        ECRF_DESIGN BOOLEAN not null,
    ...
    create table users (
        ...
        MODIFIED_TIMESTAMP TIMESTAMP WITHOUT TIME ZONE not null,
        LOCKED BOOLEAN not null,
        LOCKED_UNTRUSTED BOOLEAN not null,
        LOCALE CHARACTER VARYING(1024) not null,
