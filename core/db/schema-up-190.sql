...
if get_database_version() < '010801103' then

  insert into PROBAND_LIST_STATUS_TYPE
    ("id", "color", "initial", "name_l10n_key", "reason_required", "blocking", "count", "screening", "ic", "ecrf_value_input_enabled", "signup", "person")
  values (nextval('hibernate_sequence'), 'SPRINGGREEN', 'f', 'ic_signed_re_screening', 'f', 't', 't', 'f', 't', 't', 'f', 't');
  ...
  perform set_database_version('010801103');
  
end if;

if get_database_version() < '010801104' then

  ALTER TABLE MASS_MAIL
    ADD COLUMN ATTACH_INQUIRIES_OPTIONAL BOOLEAN,
    ADD COLUMN ATTACH_PROBAND_LIST_ENTRY_TAGS_OPTIONAL BOOLEAN,
    ADD COLUMN ATTACH_ECRFS_OPTIONAL BOOLEAN,
    ADD COLUMN ATTACH_PROBAND_LETTER_OPTIONAL BOOLEAN,
    ADD COLUMN ATTACH_REIMBURSEMENTS_PDF_OPTIONAL BOOLEAN,
    ADD COLUMN ATTACH_VISIT_PLANS_OPTIONAL BOOLEAN,
    ADD COLUMN ATTACH_PROBAND_FILES_OPTIONAL BOOLEAN,
    ADD COLUMN ATTACH_TRIAL_FILES_OPTIONAL BOOLEAN,
    ADD COLUMN ATTACH_MASS_MAIL_FILES_OPTIONAL BOOLEAN;
    
  UPDATE MASS_MAIL SET ATTACH_INQUIRIES_OPTIONAL = 'f',
    ATTACH_PROBAND_LIST_ENTRY_TAGS_OPTIONAL = 'f',
    ATTACH_ECRFS_OPTIONAL = 'f',
    ATTACH_PROBAND_LETTER_OPTIONAL = 'f',
    ATTACH_REIMBURSEMENTS_PDF_OPTIONAL = 'f',
    ATTACH_VISIT_PLANS_OPTIONAL = 'f',
    ATTACH_PROBAND_FILES_OPTIONAL = 'f',
    ATTACH_TRIAL_FILES_OPTIONAL = 'f',
    ATTACH_MASS_MAIL_FILES_OPTIONAL = 'f';
    
  ALTER TABLE MASS_MAIL
    ALTER ATTACH_INQUIRIES_OPTIONAL SET NOT NULL,
    ALTER ATTACH_PROBAND_LIST_ENTRY_TAGS_OPTIONAL SET NOT NULL,
    ALTER ATTACH_ECRFS_OPTIONAL SET NOT NULL,
    ALTER ATTACH_PROBAND_LETTER_OPTIONAL SET NOT NULL,
    ALTER ATTACH_REIMBURSEMENTS_PDF_OPTIONAL SET NOT NULL,
    ALTER ATTACH_VISIT_PLANS_OPTIONAL SET NOT NULL,
    ALTER ATTACH_PROBAND_FILES_OPTIONAL SET NOT NULL,
    ALTER ATTACH_TRIAL_FILES_OPTIONAL SET NOT NULL,
    ALTER ATTACH_MASS_MAIL_FILES_OPTIONAL SET NOT NULL;
