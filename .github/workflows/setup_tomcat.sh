...
sed -r -i "s|# Security|# Security\\nReadWritePaths=/ctsms/external_files/ /ctsms/bulk_processor/output/ /ctsms/ /tmp/ /home/runner/work/ctsms/ /home/runner/work/ctsms/ctsms/.github/workflows/|" /usr/lib/systemd/system/tomcat9.service
