#!/bin/bash
mvn surefire:test -Dtest=$1 -DskipTests=false -Dwebdriver.chrome.driver="/usr/bin/chromedriver" -Dctsms.base.url="http://localhost:8080" -Dctsms.log.path="/home/runner/work/ctsms/testoutput" -DsurefireReportsDirectory="/home/runner/work/ctsms/testoutput" --no-transfer-progress
