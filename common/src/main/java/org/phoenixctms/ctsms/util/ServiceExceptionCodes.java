...
public interface ServiceExceptionCodes {
	...
	public final static String INVALID_TRAINING_RECORD_SECTION_ID = "invalid_training_record_section_id";
	...
	public final static String MAINTENANCE_SCHEDULE_ITEM_INVALID_RESPONSIBLE_PERSON_PROXY_STAFF_ID = "maintenance_schedule_item_invalid_responsible_person_proxy_staff_id";
	...
	public final static String MAINTENANCE_SCHEDULE_ITEM_RESPONSIBLE_PERSON_OR_PROXY_REQUIRED = "maintenance_schedule_item_responsible_person_or_proxy_required";
	...
	public final static String INVALID_TRAINING_RECORD_SECTION_ID_PRESET = "invalid_training_record_section_id_preset";
	...
	public final static String VISIT_SCHEDULE_ITEM_START_TIMESTAMP_REQUIRED = "visit_schedule_item_start_timestamp_required";
	public final static String VISIT_SCHEDULE_ITEM_START_TIMESTAMP_NOT_NULL = "visit_schedule_item_start_timestamp_not_null";
	public final static String VISIT_SCHEDULE_ITEM_END_TIMESTAMP_REQUIRED = "visit_schedule_item_end_timestamp_required";
	public final static String VISIT_SCHEDULE_ITEM_END_TIMESTAMP_NOT_NULL = "visit_schedule_item_end_timestamp_not_null";
	public final static String VISIT_SCHEDULE_ITEM_START_TAG_REQUIRED = "visit_schedule_item_start_tag_required";
	public final static String VISIT_SCHEDULE_ITEM_START_TAG_NOT_NULL = "visit_schedule_item_start_tag_not_null";
	public final static String VISIT_SCHEDULE_ITEM_START_TAG_FIELD_NOT_TIMESTAMP = "visit_schedule_item_start_tag_field_not_timestamp";
	public final static String VISIT_SCHEDULE_ITEM_WRONG_START_TAG = "visit_schedule_item_wrong_start_tag";
	public final static String VISIT_SCHEDULE_ITEM_STOP_TAG_REQUIRED = "visit_schedule_item_stop_tag_required";
	public final static String VISIT_SCHEDULE_ITEM_END_TAG_NOT_NULL = "visit_schedule_item_end_tag_not_null";
	public final static String VISIT_SCHEDULE_ITEM_END_TAG_FIELD_NOT_TIMESTAMP = "visit_schedule_item_end_tag_field_not_timestamp";
	public final static String VISIT_SCHEDULE_ITEM_START_TAG_EQUALS_END_TAG = "visit_schedule_item_start_tag_equals_end_tag";
	public final static String VISIT_SCHEDULE_ITEM_WRONG_END_TAG = "visit_schedule_item_wrong_end_tag";
	public final static String VISIT_SCHEDULE_ITEM_OFFSET_SECONDS_NOT_NULL = "visit_schedule_item_offset_seconds_not_null";
	public final static String VISIT_SCHEDULE_ITEM_DURATION_REQUIRED = "visit_schedule_item_duration_required";
	public final static String VISIT_SCHEDULE_ITEM_DURATION_NOT_NULL = "visit_schedule_item_duration_not_null";
	public final static String VISIT_SCHEDULE_ITEM_DURATION_LESS_THAN_ONE = "visit_schedule_item_duration_less_than_one";
	...
	public final static String PROBAND_LIST_ENTRY_TAG_STRATIFIKATION_AND_RANDOMIZE = "proband_list_entry_tag_stratifikation_and_randomize";
	public final static String PROBAND_LIST_ENTRY_TAG_STRATIFICATION_FIELD_NOT_SELECT_ONE = "proband_list_entry_tag_stratification_field_not_select_one";
	public final static String PROBAND_LIST_ENTRY_TAG_RANDOMIZE_FIELD_NOT_SELECT_ONE_OR_SINGLE_LINE_TEXT = "proband_list_entry_tag_randomize_field_not_select_one_or_single_line_text";
	public final static String PROBAND_LIST_ENTRY_TAG_RANDOMIZE_FIELD_NOT_SELECT_ONE = "proband_list_entry_tag_randomize_field_not_select_one";
	public final static String PROBAND_LIST_ENTRY_TAG_RANDOMIZE_FIELD_NOT_SINGLE_LINE_TEXT = "proband_list_entry_tag_randomize_field_not_single_line_text";
	public final static String PROBAND_LIST_ENTRY_TAG_STRATIFICATION_FIELD_NOT_UNIQUE = "proband_list_entry_tag_stratification_field_not_unique";
	public final static String PROBAND_LIST_ENTRY_TAG_RANDOMIZE_NOT_UNIQUE = "proband_list_entry_tag_randomize_not_unique";
	...
	public final static String PROBAND_LIST_ENTRY_TAG_INPUT_FIELD_NOT_TIMESTAMP = "proband_list_entry_tag_input_field_not_timestamp";
	...
	public final static String AMBIGOUS_SELECTION_SET_VALUE_FOR_STRATIFICATION_FIELD = "ambigous_selection_set_value_for_stratification_field";
	public final static String SELECTION_SET_VALUE_FIELD_NOT_A_STRATIFICATION_FIELD = "selection_set_value_field_not_a_stratification_field";
	public final static String MISSING_STRATIFICATION_FIELD_SELECTION_SET_VALUES = "missing_stratification_field_selection_set_values";
	public final static String STRATIFICATION_FIELD_SELECTION_SET_VALUES_NOT_UNIQUE = "stratification_field_selection_set_values_not_unique";
	public final static String NO_PROBAND_LIST_ENTRY_TAG_STRATIFICATION_FIELDS = "no_proband_list_entry_tag_stratification_fields";
	...
	public final static String ECRF_FIELD_REF_NOT_UNIQUE = "ecrf_field_ref_not_unique";
	...
	public final static String UNKNOWN_PROBAND_GROUP_TOKEN = "unknown_proband_group_token";
	public final static String UNKNOWN_INPUT_FIELD_SELECTION_SET_VALUE_VALUE = "unknown_input_field_selection_set_value_value";
	public final static String NO_PROBAND_GROUP_RANDOMIZED = "no_proband_group_randomized";
	...
	public static final String TRIAL_RANDOMIZATION_LIST_NOT_NULL = "trial_randomization_list_not_null";
	public static final String POPULATION_LESS_THAN_ONE = "population_less_than_one";
	public static final String NO_PROBAND_GROUPS = "no_proband_groups";
	public static final String NO_INPUT_FIELD_SELECTION_SET_VALUES = "no_input_field_selection_set_values";
	public static final String INPUT_FIELD_SELECTION_SET_VALUE_RANDOMIZATION_NOT_SUPPORTED = "input_field_selection_set_value_randomization_not_supported";
	...
	public static final String JOB_CRITERIA_ONLY_ALLOWED = "job_criteria_only_allowed";
